...
OUTPUT_DIR = "/rds/general/project/lms-scott-raw/live/Ada/perturbation_modeling/T_perturb/res/masking"  # relative to repo root, here set the output directory
CKPT_MASKING_PATH = "/rds/general/project/lms-scott-raw/live/Ada/perturbation_modeling/T_perturb/res/checkpoints/20260609_0537_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1_s_0-epoch=19.ckpt" # same as in decoder training - path to load masking model checkpoint from masking training of notebook 03
...
TOKENID_TO_ROWID = "/rds/general/project/lms-scott-raw/live/Ada/perturbation_modeling/T_perturb/tokenized_data/adipocytes_subset_obese_WL/tokenid_to_rowid_all.pkl" # path/to/tokenid_to_rowid.pkl from tokenization step
